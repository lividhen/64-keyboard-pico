...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_64_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL,          _______,
        ...
        _______, _______, _______, _______,                       _______,                        _______, MO(2),   KC_HOME, KC_PGDN, KC_END
    ),
    [2] = LAYOUT_64_ansi(
